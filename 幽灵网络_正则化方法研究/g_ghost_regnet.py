...
class GGhostRegNet(nn.Module):
    ...
    def __init__(self, block, layers, widths, num_classes=10, zero_init_residual=True,#block是Bottleneck的个数
                 group_width=1, replace_stride_with_dilation=None,
                 norm_layer=None):
        #GGhostRegNet(Bottleneck, [2, 5, 14, 2], [80, 240, 560, 1360], group_width=40, **kwargs)
